...
class StudentSignUpScreen extends StatefulWidget {
  ...
  @override
  State<StudentSignUpScreen> createState() => _StudentSignUpScreen();
}

class _StudentSignUpScreen extends State<StudentSignUpScreen> {
            ...
            child: Form(
              ...
              child: Column(children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                  IconButton(
                    icon:
                    Image.asset("assets/icons8-left-arrow-24.png", width: 25),
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
